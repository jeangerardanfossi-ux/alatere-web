...
const D = FORMA_DOMAIN_BY_SLUG['webmarketing'];
const FR = '/alatere-forma/webmarketing';
const DESC_EN =
  'Web marketing courses in Antibes: SEO, SEA, AEO, social ads, analytics and e-commerce. Qualiopi-certified provider, OPCO funding.';
